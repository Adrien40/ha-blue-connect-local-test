...
[![Tests](https://img.shields.io/github/actions/workflow/status/Adrien40/ha-blue-connect-local-test/tests.yml?branch=main&label=tests)](https://github.com/Adrien40/ha-blue-connect-local-test/actions/workflows/tests.yml)
[![Validate](https://img.shields.io/github/actions/workflow/status/Adrien40/ha-blue-connect-local-test/validate.yml?branch=main&label=hassfest%2Fhacs)](https://github.com/Adrien40/ha-blue-connect-local-test/actions/workflows/validate.yml)
[![Linting](https://img.shields.io/github/actions/workflow/status/Adrien40/ha-blue-connect-local-test/lint.yml?branch=main&label=lint)](https://github.com/Adrien40/ha-blue-connect-local-test/actions/workflows/lint.yml)
[![CodeQL](https://img.shields.io/github/actions/workflow/status/Adrien40/ha-blue-connect-local-test/codeql.yml?branch=main&label=codeql)](https://github.com/Adrien40/ha-blue-connect-local-test/actions/workflows/codeql.yml)
